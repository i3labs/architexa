...
function validate()
{
	...
	JSONObject.title = p['title'].value;
	JSONObject.company = p['company'].value;
	JSONObject.website = p['website'].value;
	JSONObject.planName = p['planName'].value;
...
<h2 style="width:405px; text-align:left;">1. Register<a style="color:grey; font-weight:normal;" href="/learn-more/install">&nbsp&nbsp>>&nbsp 2. Download</a><a style="color:grey; font-weight:normal;" href="/learn-more/tour">&nbsp&nbsp>>&nbsp 3. Take a Tour</a></h2>
...
<div style="float:left;width:415px" id="planDescriptor">
<h1>
	Individual
Edition Signup</h1>

<div class="label" style="text-align:left;line-height:120%">
	<p>Sign up for an Architexa license. The licenses are available in exchange for your feedback.</p>
	<p>Architexa Individual Edition includes:
	<ul>
		<li>Free for 3 users</li>
		<li>Powerful Diagramming Engine: Layered Architectural Diagrams, Class Diagrams, and Sequence Diagrams</li>
		<li>Share diagrams that are linked to your code</li>
		<li>Online Support via our Forums</li>
	</ul>
	</p>
...
<div style="float:left;width:335px;margin-left:30px">
...
<tr> 
<td colspan="2" id="response" style="color:red;font-weight:bold;"></td> 
</tr> 
...
-->
<tr><td colspan="2">
	<h2>Register for a Free license</h2>
</td><td></td></tr> 
...
-->
<tr> 
	<td class="label">Name:<sup><span style="color:red">*</span></sup></td> 
	<td>
		<div class="p-input">
...
<tr> 
	<td class="label">Password:<sup><span style="color:red">*</span></sup></td> 
	<td>
		<div class="p-input">
...
<tr> 
	<td class="label">Email:<sup><span style="color:red">*</span></sup></td> 
	<td>
		<div class="p-input">
...
-->
<tr> 
	<td class="label">Phone:<sup><span style="color:red">*</span></sup></td> 
	<td>
		<div class="p-input">
...
<tr> 
	<td class="label">Title:<sup><span style="color:red">*</span></sup></td> 
	<td>
		<div class="p-input">
...
<tr> 
	<td class="label">Company:<sup><span style="color:red">*</span></sup></td> 
	<td>
		<div class="p-input">
...
<input type="hidden" style="width:225" name="planName" value="individual"/> 
<script type="text/javascript"> 
...
<tr> 
   <td class="label" colspan=3><input type="checkbox" name="subscribe" value="1" checked/><label>&nbsp;Sign me up for the Newsletter!</label></td> 
</tr> 

<tr><td colspan="3"><br/></td> 

<tr> 
	<td colspan="2"><span style="font-style:italic">An email confirmation link will be sent to the above address. Check your inbox before installing Architexa.</span></td> 
	<td></td> 
</tr> 
...
<input type="hidden" name="referrer" value=",2013-02-12" />
...
Copyright &copy;2012 Architexa, Inc. All rights reserved.
<a href="http://www.architexa.com/privacy">Privacy Policy</a> | 
<a href="http://www.architexa.com/terms-of-service"> Terms of Use</a> 
</div>
