...
<div class="tableBox" style="height:370px;">
<div class="leftTop">
	<table>
		<tr valign="top">
			<td style="text-align:center">
			<span class="planName" >Standard Edition</span><br><br><span id="basicPrice" style="padding-right:10px; color:black; font-size: 1.6em;font-style:italic;">$249/year</span><br><br>
			</td>
		</tr>
...
<div class="leftTop">
	...
	<tr valign="top">
		<td style="text-align:center">
		<span class="planName" style="font-size: 1.8em;">Professional Edition</span><br><br><span id="profPrice" style="padding-right:10px; color:black; font-size: 1.6em;font-style:italic;">$449/year</span><br><br>
		</td>
	</tr>
...
<div class="rightTop" style="background-color:#FFF;">
	...
	<ul class="tick">
		<li class="short">
			<span class="head">Dedicated local server to host diagrams inside your company network <a href = "http://www.architexa.com/user-guide/Server/Group" target = "_blank">[read more]</a></span>
			<div class="body"></div>
		</li> 
	</ul> 
</div><!--end rightTop-->
...
<div style="float:left;"><img class="fineIcon" src="/images/date_g.png"/><p>We want to make sure that you like Architexa's suite, so all users receive a <b>free 30 day trial account - no credit card info required.</b></p></div>
<div style="clear:both;"></div>

<div style="float:left;"><img class="fineIcon" src="/images/check_g.png"/><p class="finePrint">Once signed up for a trial account, you can upgrade to a paid license. Each paid license is renewable yearly, includes online support, and gives increased priority for bug fixes and feature requests. It can be cancelled at any time.</p></div>
<div style="clear:both;"></div>
