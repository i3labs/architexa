...
$local = FALSE;
if (strEnd($plan,"?local")) {
	$local = TRUE;
	$plan = substr($plan, 0, -6);
}
?>
...
<?php } else { ?>
		url: "http://www.architexa.com/learn-more/registerJSONP",
<?php } ?>
		dataType: "jsonp",
		cache: false,
...
<?php } else { ?>
	<h2>Register for a Community license</h2>
<?php } ?>
</td><td></td></tr> 
...
<!--
<tr> 
	<td class="label">Re-Enter Password <span style="color:red; font-size:.7em;" >(required)</span></td> 
