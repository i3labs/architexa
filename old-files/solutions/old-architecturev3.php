...
<h3>
Making sense of fragmented code with UML
</h3>

<p>
Architexa generates UML diagrams to help developers to have a shared overview of the code and provide a consistent point of reference for developers.This prevents excessive code duplication as it allows developers to understand the overall architecture better. Deeper architectural issues could be thoroughly examined and shared components could be identified for reuse.
</p>
<p>
Each developer can code according to the architectural needs for a specific part of the project with clear module 
boundaries defined. Code duplication could also be avoided as they will know which features are already 
available through the diagrams.
</p>
...
<p>
Architectural diagrams also ensure essential capabilities are clearly identified and not missed, preventing any 
unpleasant development surprises such as missing software requirement from occurring in the future. 
</p>
