...
<td >
<div style="float:right; margin: 5pt 0pt 0pt 0px;"> 
	<a href="/images/thumbnails/architecturechallenge.png" rel="prettyPhoto" title="Architectural challenges" > 
	<img style="margin=0 0 0 10px;" src="/images/thumbnails/architecturechallenge.png" width="300" border="0"/> 
	</a> 
...
<tr>
<td width="300">	<a href="/images/thumbnails/architecturechallenge.png" rel="prettyPhoto" title="Architectural challenges" > 
<p align="center"></p>
	</a></td>
</tr>
</table>

<h4>Undetected missing requirements</h4>
...
<h4>Difficulty using shared components</h4>
...
<h4>Architectural erosion and code overlap</h4>
...
<p>Diagrams built straight from the code allow developers to be connected 
to the code, and high-level overview diagrams like <a 
href="/learn-more/layered-diagrams">Layered 
Diagrams</a> show developers major code modules for them to dive into.  
...
href="/learn-more/layered-diagrams">get high-level 
overviews</a>, <a href="/learn-more/class-diagrams">see 
definitions of core code components</a>, and <a 
href="/learn-more/sequence-diagrams">examine the 
...
href="/learn-more/document">diagrams with added notes 
