...
-->
<?php
    //$nextTues = date('F jS, Y', strtotime('next tuesday'));
    //print_r( $nextTues);
?>
...
<iframe src="https://docs.google.com/a/architexa.com/spreadsheet/embeddedform?formkey=dG93dkdyZlB1VEdtYXNmTnlfVk1VS0E6MQ" width="500" height="828" frameborder="0" marginheight="0" marginwidth="0">Loading...</iframe>
</div>
<br><br>
