 ...
 * <P>
 * A {@link com.architexa.org.eclipse.gef.tools.SelectionTool} will be the active Tool until:
 * <UL>
 *   <LI>A {@link com.architexa.org.eclipse.gef.palette.PaletteRoot} is provided which contains a
 *   default entry which is a {@link com.architexa.org.eclipse.gef.palette.ToolEntry}. In which
 *   case that entry's tool is made the active Tool.
 * </UL>
 * <P>
 * DefaultEditDomain can be configured with a 
 * {@link com.architexa.org.eclipse.gef.ui.palette.PaletteViewer}. When provided, the
