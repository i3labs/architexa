...
abstract class ToggleButtonTracker extends SingleSelectionTracker {
	...
	protected boolean handleDrag() {
		com.architexa.org.eclipse.draw2d.geometry.Point point = getLocation().getCopy();
...
/**
 * @see com.architexa.org.eclipse.gef.internal.ui.palette.editparts.PaletteEditPart#deactivate()
 */
public void deactivate() {
	customLabel.dispose();
	super.deactivate();
...
/**
 * @see com.architexa.org.eclipse.gef.EditPart#eraseTargetFeedback(Request)
 */
...
/**
 * @see com.architexa.org.eclipse.gef.internal.ui.palette.editparts.PaletteEditPart#getToolTipText()
 */
...
/**
 * @see com.architexa.org.eclipse.gef.EditPart#showTargetFeedback(Request)
 */
