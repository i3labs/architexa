...
import com.architexa.org.eclipse.gef.dnd.TemplateTransfer;
import com.architexa.org.eclipse.gef.internal.GEFMessages;
import com.architexa.org.eclipse.gef.internal.Internal;
import com.architexa.org.eclipse.gef.ui.views.palette.PaletteView;
...
private static class TitleLabel extends Label {
	...
	protected void paintFigure(Graphics graphics) {
		super.paintFigure(graphics);
		com.architexa.org.eclipse.draw2d.geometry.Rectangle area = 
				getBounds().getCropped(super.getInsets());
		com.architexa.org.eclipse.draw2d.geometry.Rectangle textBounds = getTextBounds();
