 ...
 *
 */
public abstract class RevisionDiagramGenerator {
	...
	public RevisionDiagramGenerator(UncommittedChangesDiagramGenerator generator) {
		...
		for(final Object obj : menuExtenders) {
			...
			PMEUtil.getManager(pme).addMenuListener(new IMenuListener() {
				public void menuAboutToShow(IMenuManager menuMgr) {
					...
					RSEMenuAction openChangesAsSubMenu = new RSEMenuAction(RevisionViewGenerateAction.actionId, "Open Changes Made In Change Set(s) As ", rseIcon) {
						@Override
