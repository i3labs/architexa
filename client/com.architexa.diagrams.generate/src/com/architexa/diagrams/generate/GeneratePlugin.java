...
public class GeneratePlugin extends AbstractUIPlugin {
	...
	public static final String PLUGIN_ID = "com.architexa.diagrams.generate";
	...
	public static Logger getLogger(Class<?> clazz) {
		return EclipseLog4JUtils.getLogger(GeneratePlugin.PLUGIN_ID, clazz);
	}

	public static Logger getLogger(String name) {
		return EclipseLog4JUtils.getLogger(GeneratePlugin.PLUGIN_ID, name);
	}
