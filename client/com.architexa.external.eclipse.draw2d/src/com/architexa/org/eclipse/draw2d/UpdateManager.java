...
/**
 * Allows someone to create a new update manager and install it
 */
public void addAllListeners(UpdateManager oldUM) {
	for (UpdateListener listener : oldUM.listeners) {
