...
/**
 * A viewport for {@link com.architexa.org.eclipse.draw2d.FreeformFigure FreeformFigures}.  
...
protected void readjustScrollBars() {
	...
	bounds.union(Math.min(0, clientArea.x), Math.min(0, clientArea.y), clientArea.width, clientArea.height);
