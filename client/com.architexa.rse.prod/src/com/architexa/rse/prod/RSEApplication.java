...
/**
 * Identical to org.eclipse.ui.internal.ide.application.IDEApplication, but...
 * We want to change the WorkbenchWindowAdvisor, so we need to put in our own WorkbenchAdvisor
 */
@SuppressWarnings({ "rawtypes", "restriction", "deprecation" })
public class RSEApplication implements IApplication, IExecutableExtension {
	...
	public Object start(IApplicationContext appContext) throws Exception {
        ...
        try {
            ...
            int returnCode = PlatformUI.createAndRunWorkbench(display,
            		new RSEWorkbenchAdvisor(processor));
