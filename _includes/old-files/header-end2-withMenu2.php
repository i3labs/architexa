...
<div width="100%"> 
	...
	<!--[if IE ]>
	<img alt=" " style="position:relative;bottom:-5px; left:-2px;" src="../images/mainbody-wrap.gif">
	<![endif]-->
	<!--[if !IE]>-->
	<img alt=" " style="position:relative;bottom:-5px;" src="../images/mainbody-wrap.gif">
	<!--<![endif]-->
</div>
