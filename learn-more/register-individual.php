...
<tr><td colspan="3" class="label" style="text-align:left;line-height:120%">Sign up for an Architexa license. Free licenses are available in exchange for your feedback for teams of up to 3 people.</td></tr>
<tr><td colspan="3"><br/></td></tr>
<!--
...
<tr> 
	...
	<td><div class="p-input">
		<input type="text" style="width:225" name="inviteCodeName" value="<?=$code?>"/> 
	</div></td>
	<td></td> 
</tr> 
<? } ?>
...
<tr> 
   <td class="label" colspan=3><input type="checkbox" name="subscribe" value="1" checked/><label>&nbsp;Sign me up for the Architexa Newsletter!</label></td> 
</tr> 
