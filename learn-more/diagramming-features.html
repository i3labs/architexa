...
<p>Architexa allows you to build diagrams quickly from your code. With an easy-to-use and powerful 
UI you can create code diagrams that make sense.
</p>
...
<table style = "text-align:center" >
	...
	<tr  VALIGN=TOP style = "font-size: 80%">
		<td style="width: 200px;">
	  	Gain mile-high views of your code by using layered architectural diagrams created by a single click. <a href="/learn-more/layered-diagrams"><b>Learn more</b></a>
		</td>
			
		<td style="width: 200px;">
		Benefit from seeing a class diagram of your code and all relevant relationships. <a href="/learn-more/class-diagrams"><b>Learn more</b></a>
		</td>
		
		<td style="width: 200px;">
		Analyze logic easily by looking at control flow in sequence diagrams. <a href="/learn-more/sequence-diagrams"><b>Learn more</b></a>
		</td>
...
<table align="center">
	<tr style = "vertical-align:top;"> 
		<td style="width:268px;">
			<div>
			<p style="font-size: 18px; margin:0 0 10px 0;"><a href="/learn-more/layered-diagrams"><b>Layered Diagrams</b></a></p>
		...
		<td style="width:268px;">
			<div>
			<p style="font-size: 18px; margin:0 0 10px 0;"><a href="/learn-more/class-diagrams"><b>Class Diagrams</b></a></p>
			<ul style="font-size:14px; ">
		...
		<td style="width:268px;">
			<div>
			<p style="font-size: 18px; margin:0px 0 10px 0;"><a href="/learn-more/sequence-diagrams"><b>Sequence Diagrams</b></a></p>
			<ul style="font-size:14px; ">
	...
	<tr style = "vertical-align:top;"> 
		<td style="width:268px;">
			<div>
			<p style="font-size: 18px; margin:0 0 10px 0;"><a href="/learn-more/ide-integration"><b>IDE Integration</b></a></p>
			<ul style="font-size:14px;">
		...
		<td style="width:268px;">
			<div>
			<p style="font-size: 18px; margin:0 0 10px 0;"><a href="/learn-more/share"><b>Collaboration</b></a></p>
			<ul style="font-size:14px; ">
		...
		<td style="width:268px;">
			<div>
			<p style="font-size: 18px; margin:0px 0 10px 0;"><a href="/learn-more/document"><b>Documentation</b></a></p>
			<ul style="font-size:14px; ">
...
<p>
<ul>
<li>View code organization</li>
<li>Examine code dependencies</li>
<li>Detect code cycles</li>
</ul>
</p>
